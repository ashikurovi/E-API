...
export class NotificationsService {
  ...
  async sendEmailToCustomers(dto: BroadcastEmailDto) {
    ...
    if (!recipients.length) {
      throw new NotFoundException(
        'No customers with a valid email address were found',
      );
    }
  ...
  async sendSmsToCustomers(dto: BroadcastSmsDto) {
    ...
    const results = await Promise.allSettled(
      recipients.map((user) =>
        this.dispatchSms(config, user.phone, dto.message),
      ),
    );
  ...
  async saveOrderCreatedForNavbar(
    companyId: string,
    orderId: number,
    subject: string,
    message: string,
  ...
  async saveNewCustomerNotification(
    companyId: string,
    customerName: string,
  ...
  async saveCustomerUpdatedNotification(
    companyId: string,
    customerName: string,
    customerId: number,
  ) {
  ...
  async saveProductAddedNotification(
    companyId: string,
    productName: string,
    productId: number,
    sku?: string,
  ...
  async saveProductUpdatedNotification(
    companyId: string,
    productName: string,
    productId: number,
    sku?: string,
  ...
  async saveLowStockNotification(
    companyId: string,
    productName: string,
    productId: number,
    stock: number,
  ...
  async saveOutOfStockNotification(
    companyId: string,
    productName: string,
    productId: number,
    sku?: string,
  ...
  async getNotificationsByCompanyAndType(
    companyId: string,
    type?: NotificationType,
  ) {
